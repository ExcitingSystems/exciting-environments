...
class SixPhasePMSM(CoreEnvironment):
        ...
        if LUT_motor_name is not None:
            ...
            if saturated:
                raise NotImplementedError(
                    "Saturated multiphase PMSM is not implemented yet."
                )
    ...
    def init_state(self, env_properties, rng: chex.PRNGKey = None, vmap_helper=None):
        ...
        force = lambda t: jnp.array(
            [0, 0, 0, 0, 0, 0]
        )  # u_d, u_q, u_x, u_y, u_0p, u_0m
        ...
        t1 = self.tau
        y0 = tuple(
            [phys.i_d, phys.i_q, phys.i_x, phys.i_y, phys.i_0p, phys.i_0m, phys.epsilon]
        )
    ...
    def constraint_denormalization(self, u_vec_norm, system_state, env_properties):
        ...
        return jnp.hstack([u_dq, u_vec[2:]])
