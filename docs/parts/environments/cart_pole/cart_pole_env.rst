...
.. math::
      ...
      \ddot{\theta_t}= \frac{g\sin{\theta_t}+\cos{\theta_t}[\frac{-u_t-ml{\dot{\theta_t}}^2 \sin{\theta_t}+\mu_c \textrm{sgn}({\dot{x}})}{m_c+m_p}]-\frac{\mu_p \dot{\theta_t}}{m_p l}}{l [\frac{4}{3}- \frac{m_p {\cos^2{\theta_t}}}{m_c + m_p}]} \\
